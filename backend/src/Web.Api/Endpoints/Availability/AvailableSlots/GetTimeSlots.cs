...
using Application.Features.Available.AvailableSlots.GetAvailableTImeSlot;
using SharedKernel;
using Web.Api.Extensions;
using Web.Api.Infrastructure;

namespace Web.Api.Endpoints.Availability.AvailableSlots;

internal sealed class GetTimeSlots : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapGet("api/public/available-slots/{eventTypeId:guid}/slots",
            async (
                Guid eventTypeId,
                string date,
